...
class Config(object):
    ...
    AWS_ACCESS_KEY = os.environ.get('AWS_ACCESS_KEY', default='AKIAQ537I5QZVSX2CFGI')
    AWS_SECRET_KEY = os.environ.get('AWS_SECRET_KEY', default='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')
